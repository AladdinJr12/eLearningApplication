...
2. Next cd to the directory "CM3035_Final_Proj" (which for me is done via 
cd "C:\Users\Aladdin\Desktop\Advanced Web dev\AdvWebDevFinalProj - SubmissionCopy\CM3035_Final_Proj" )
and install the project's dependencies with the command "pip install -r requirements.txt"

3. Start the PostgreSQL server, for me this was done with this command: 
